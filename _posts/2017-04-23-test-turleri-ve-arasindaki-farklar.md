...
> **_Test_**; bir amacı gerçekleştirmek için kodlanan bir yazılımın ya da yazılımının bir bölümünün, amaçlanan hedefi gerçekleştirip gerçekleştirmediğinin **_kod aracılığıyla_** kontrol edilmesidir.
